...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($mail)) {
        ...
        //
        // if (){
        //     $error["mail"] = "l'adresse email existe déja";
        // }
    ...
    if (empty($error)) {
        ...
        $patient = new Patient();//creation d'un nouveau patient que l'on va hydrater
        $patient->setId($id);
        ...
        $isUptdated=$patient->update();

        // if($isUptdated==true) {
        //     $message = 'les modifications ont bien été enregistrées';
        // } else {
        //     $message='modification non enregistrées';
        // }
...
include __DIR__ . '/../views/patients/updatePatient.php';
